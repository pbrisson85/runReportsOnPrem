...
const l1_getSalesByFiscalQuarter = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.quarter_serial, ${sql(config.baseFormat.l1_field)} 
...
const l2_getSalesByFiscalQuarter = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.quarter_serial, ${sql(config.baseFormat.l1_field)}, ${sql(config.baseFormat.l2_field)} 
...
const l3_getSalesByFiscalQuarter = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.quarter_serial, ${sql(config.baseFormat.l1_field)}, ${sql(config.baseFormat.l2_field)}, ${sql(config.baseFormat.l3_field)} 
...
const l4_getSalesByFiscalQuarter = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.quarter_serial, ${sql(config.baseFormat.l1_field)}, ${sql(config.baseFormat.l2_field)}, ${sql(config.baseFormat.l3_field)}, ${sql(config.baseFormat.l4_field)} 
...
const l5_getSalesByFiscalQuarter = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.quarter_serial, ${sql(config.baseFormat.l1_field)}, ${sql(config.baseFormat.l2_field)}, ${sql(config.baseFormat.l3_field)}, ${sql(config.baseFormat.l4_field)}, ${sql(config.baseFormat.l5_field)} 
