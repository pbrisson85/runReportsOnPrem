...
const l1_getSo_byFiscalPeriod = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.period_serial, ${sql(config.baseFormat.l1_field)} 
...
const l2_getSo_byFiscalPeriod = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.period_serial, ${sql(config.baseFormat.l1_field)}, ${sql(config.baseFormat.l2_field)} 
...
const l3_getSo_byFiscalPeriod = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.period_serial, ${sql(config.baseFormat.l1_field)}, ${sql(config.baseFormat.l2_field)}, ${sql(config.baseFormat.l3_field)} 
...
const l4_getSo_byFiscalPeriod = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.period_serial, ${sql(config.baseFormat.l1_field)}, ${sql(config.baseFormat.l2_field)}, ${sql(config.baseFormat.l3_field)}, ${sql(config.baseFormat.l4_field)} 
...
const l5_getSo_byFiscalPeriod = async config => {
  try {
    ...
    const response = await sql
      ...
      GROUP BY p.period_serial, ${sql(config.baseFormat.l1_field)}, ${sql(config.baseFormat.l2_field)}, ${sql(config.baseFormat.l3_field)}, ${sql(config.baseFormat.l4_field)}, ${sql(config.baseFormat.l5_field)} 
