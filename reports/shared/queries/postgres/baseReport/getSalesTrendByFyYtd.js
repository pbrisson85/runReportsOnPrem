...
const lvl_2_subtotal_getSalesByFyYtd = async (config, start, end, program) => {
  try {
...
const lvl_3_subtotal_getSalesByFyYtd = async (config, start, end, program) => {
  try {
...
const lvl_0_total_getSalesByFyYtd = async (config, start, end, program) => {
  try {
