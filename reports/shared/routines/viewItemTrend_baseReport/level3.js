...
} = require('../../queries/postgres/viewItemTrend_baseReport/byItem_level3/getSalesTrend')
...
} = require('../../queries/postgres/viewItemTrend_baseReport/byItem_level3/getSalesTrendByFy')
const {
  lvl_1_subtotal_getSalesByFyYtd,
  lvl_0_total_getSalesByFyYtd,
} = require('../../queries/postgres/viewItemTrend_baseReport/byItem_level3/getSalesTrendByFyYtd')
const {
...
} = require('../../queries/postgres/viewItemTrend_baseReport/byItem_level3/getFgInven')
const { lvl_1_subtotal_getFgPo, lvl_0_total_getFgPo } = require('../../queries/postgres/viewItemTrend_baseReport/byItem_level3/getFgOpenPo')
const {
...
} = require('../../queries/postgres/viewItemTrend_baseReport/byItem_level3/getSo')
const {
...
} = require('../../queries/postgres/viewItemTrend_baseReport/byItem_level3/getSoByWeek')
const { getRowsFirstLevelDetail } = require('../../queries/postgres/viewItemTrend_baseReport/byItem_level3/getRows')
const {
  getRowsFirstLevelDetail: getRows_l1_showFyTrend,
} = require('../../queries/postgres/viewItemTrend_baseReport/byItem_level3/getRowsTrendByFy')
