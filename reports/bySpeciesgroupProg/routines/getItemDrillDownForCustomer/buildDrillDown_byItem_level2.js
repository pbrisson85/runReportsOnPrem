...
} = require('../../../shared/queries/postgres/viewItemTrend_inTrendByCust/byItem_level2/getSalesTrend')
...
} = require('../../../shared/queries/postgres/viewItemTrend_inTrendByCust/byItem_level2/getSalesTrendByFyYtd')
...
} = require('../../../shared/queries/postgres/viewItemTrend_inTrendByCust/byItem_level2/getFgInven')
const {
  lvl_1_subtotal_getFgPo,
  lvl_0_total_getFgPo,
} = require('../../../shared/queries/postgres/viewItemTrend_inTrendByCust/byItem_level2/getFgOpenPo')
const {
...
} = require('../../../shared/queries/postgres/viewItemTrend_inTrendByCust/byItem_level2/getSo')
const {
...
} = require('../../../shared/queries/postgres/viewItemTrend_inTrendByCust/byItem_level2/getSoByWeek')
const { getRowsFirstLevelDetail } = require('../../../shared/queries/postgres/viewItemTrend_inTrendByCust/byItem_level2/getRows')
const {
  getRowsFirstLevelDetail: getRows_l1_showFyTrend,
} = require('../../../shared/queries/postgres/viewItemTrend_inTrendByCust/byItem_level2/getRowsTrendByFy')
