...
} = require('../../shared/queries/postgres/viewCustTrend_baseReport/byCustomer_level0/getSalesTrend')
...
} = require('../../shared/queries/postgres/viewCustTrend_baseReport/byCustomer_level0/getSalesTrendByFy')
const { getFiscalYearCols, getFiscalYearYtdCols } = require('../../shared/queries/postgres/getFiscalYearCols')
const { lvl_1_subtotal_getSo, lvl_0_total_getSo } = require('../../shared/queries/postgres/viewCustTrend_baseReport/byCustomer_level0/getSo')
const {
  lvl_1_subtotal_getSo_byWk,
  lvl_0_total_getSo_byWk,
} = require('../../shared/queries/postgres/viewCustTrend_baseReport/byCustomer_level0/getSoByWeek')
const { getRowsFirstLevelDetail } = require('../../shared/queries/postgres/viewCustTrend_baseReport/byCustomer_level0/getRows')
const {
  getRowsFirstLevelDetail: getRows_l1_showFyTrend,
} = require('../../shared/queries/postgres/viewCustTrend_baseReport/byCustomer_level0/getRowsTrendByFy')
