  ...
  try {
    ...
    const response = await pgClient.query(
         ...
         FROM "salesReporting".sales_orders 
          ...
          GROUP BY sales_orders.week_serial, ms.item_num, ms.description, ms.fg_fresh_frozen, ms.fg_treatment, ms.size_name 
          
          ORDER BY sales_orders.week_serial`, ['FG', filters[3]]
        ) //prettier-ignore
