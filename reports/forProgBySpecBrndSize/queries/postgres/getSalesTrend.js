...
const lvl_1_subtotal_getSalesByWk = async (start, end, program) => {
  try {
    ...
    const response = await pgClient.query(
      ...
      GROUP BY sales_line_items.week_serial, ms.species 
...
const lvl_2_subtotal_getSalesByWk = async (start, end, program) => {
  try {
    ...
    const response = await pgClient.query(
      ...
      GROUP BY sales_line_items.week_serial, ms.species, ms.brand 
...
const lvl_3_subtotal_getSalesByWk = async (start, end, program) => {
  try {
    ...
    const response = await pgClient.query(
      ...
      GROUP BY sales_line_items.week_serial, ms.species, ms.brand, ms.size_name 
