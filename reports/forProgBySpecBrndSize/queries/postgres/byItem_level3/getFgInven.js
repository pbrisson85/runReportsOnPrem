...
WHERE ms.byproduct_type IS NULL AND ms.item_type = $1 AND ms.program = $3 AND ms.species = $4 AND ms.brand = $5 AND ms.size_name = $6`, ['FG', 'IN TRANSIT', program, filters[0], filters[1], filters[2]]
    ) //prettier-ignore
