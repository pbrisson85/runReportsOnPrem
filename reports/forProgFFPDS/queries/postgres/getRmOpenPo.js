...
const lvl_1_subtotal_getRmPo = async program => {
  try {
    ...
    console.log(`level1: query postgres for RM open PO ...`)
...
const lvl_2_subtotal_getRmPo = async program => {
  try {
    ...
    console.log(`level2: query postgres for RM open PO ...`)
...
const lvl_3_subtotal_getRmPo = async program => {
  try {
    ...
    console.log(`level3: query postgres for RM open PO ...`)
...
const lvl_0_total_getRmPo = async program => {
  try {
    ...
    console.log(`total: query postgres for RM open PO ...`)
