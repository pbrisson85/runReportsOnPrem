  ...
  try {
    ...
    const response = await pgClient.query(
        ...
        UNION SELECT ms.species AS l1_label, ms.fg_treatment AS l2_label, ms.size_name AS l3_label 
            ...
            WHERE ms.byproduct_type IS NULL AND ms.item_type = $3 AND sales_orders.version = (SELECT MAX(sales_orders.version) - 1 FROM "salesReporting".sales_orders) AND ms.program = $4 
