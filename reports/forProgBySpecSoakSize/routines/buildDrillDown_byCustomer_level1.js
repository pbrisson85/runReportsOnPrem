...
const { lvl_1_subtotal_getSalesByFy, lvl_0_total_getSalesByByFy } = require('../queries/postgres/byCustomer_level1/getSalesTrendByFy')
...
const { getRowsFirstLevelDetail: getRows_l1_showFyTrend } = require('../queries/postgres/byCustomer_level1/getRowsTrendByFy')
