...
const getViewTrendConfig = rightMenuSelection => {
  ...
  switch (rightMenuSelection) {
    case 'Trend By Item':
      trendQuery = {
        select: [
          'ms.item_num AS l1_label',
          'ms.description AS l2_label',
          'ms.fg_fresh_frozen AS l3_label',
          'ms.fg_treatment AS l4_label',
          'ms.brand AS l5_label',
          'ms.size_name AS l6_label',
        ],
