...
const l1_getPercentOfCompanySales = async config => {
...
const l2_getPercentOfCompanySales = async config => {
...
const l3_getPercentOfCompanySales = async config => {
...
const l4_getPercentOfCompanySales = async config => {
...
const l5_getPercentOfCompanySales = async config => {
...
const l0_getPercentOfCompanySales = async config => {
  try {
