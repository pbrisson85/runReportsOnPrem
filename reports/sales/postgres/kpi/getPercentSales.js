...
const l1_getPercentSales = async (config, denominator, colName) => {
  ...
  try {
    ...
    const response = await sql
      `SELECT TRUE AS "percentFormat", ${colName} AS column, COALESCE(${sql(config.baseFormat.l1_field)},'BLANK') AS l1_label, 'SUBTOTAL' AS l2_label, 'SUBTOTAL' AS l3_label, 'SUBTOTAL' AS l4_label, 'SUBTOTAL' AS l5_label, COALESCE(SUM(pj.lbs)/${(denominator.lbs)},0) AS lbs, COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSales", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS cogs, COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS othp, COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMargin", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSales", 0 AS "grossMarginPercent", 
      COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSalesPerLb", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS "cogsPerLb", COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS "othpPerLb", COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMarginPerLb", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSalesPerLb"
...
const l2_getPercentSales = async (config, denominator, colName) => {
  ...
  try {
    ...
    const response = await sql
      `SELECT TRUE AS "percentFormat", ${colName} AS column, COALESCE(${sql(config.baseFormat.l1_field)},'BLANK') AS l1_label, COALESCE(${sql(config.baseFormat.l2_field)},'NA') AS l2_label, 'SUBTOTAL' AS l3_label, 'SUBTOTAL' AS l4_label, 'SUBTOTAL' AS l5_label, COALESCE(SUM(pj.lbs)/${(denominator.lbs)},0) AS lbs, COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSales", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS cogs, COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS othp, COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMargin", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSales", 0 AS "grossMarginPercent", COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSalesPerLb", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS "cogsPerLb", COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS "othpPerLb", COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMarginPerLb", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSalesPerLb"
...
const l3_getPercentSales = async (config, denominator, colName) => {
  ...
  try {
    ...
    const response = await sql
      `SELECT TRUE AS "percentFormat", ${colName} AS column, COALESCE(${sql(config.baseFormat.l1_field)},'BLANK') AS l1_label, COALESCE(${sql(config.baseFormat.l2_field)},'NA') AS l2_label, COALESCE(${sql(config.baseFormat.l3_field)},'NA') AS l3_label, 'SUBTOTAL' AS l4_label, 'SUBTOTAL' AS l5_label, COALESCE(SUM(pj.lbs)/${(denominator.lbs)},0) AS lbs, COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSales", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS cogs, COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS othp, COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMargin", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSales", 0 AS "grossMarginPercent", COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSalesPerLb", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS "cogsPerLb", COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS "othpPerLb", COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMarginPerLb", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSalesPerLb"
...
const l4_getPercentSales = async (config, denominator, colName) => {
  ...
  try {
    ...
    const response = await sql
      `SELECT TRUE AS "percentFormat", ${colName} AS column, COALESCE(${sql(config.baseFormat.l1_field)},'BLANK') AS l1_label, COALESCE(${sql(config.baseFormat.l2_field)},'NA') AS l2_label, COALESCE(${sql(config.baseFormat.l3_field)},'NA') AS l3_label, COALESCE(${sql(config.baseFormat.l4_field)},'NA') AS l4_label, 'SUBTOTAL' AS l5_label, COALESCE(SUM(pj.lbs)/${(denominator.lbs)},0) AS lbs, COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSales", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS cogs, COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS othp, COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMargin", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSales", 0 AS "grossMarginPercent", COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSalesPerLb", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS "cogsPerLb", COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS "othpPerLb", COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMarginPerLb", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSalesPerLb"
...
const l5_getPercentSales = async (config, denominator, colName) => {
  ...
  try {
    ...
    const response = await sql
      `SELECT TRUE AS "percentFormat", ${colName} AS column, COALESCE(${sql(config.baseFormat.l1_field)},'BLANK') AS l1_label, COALESCE(${sql(config.baseFormat.l2_field)},'NA') AS l2_label, COALESCE(${sql(config.baseFormat.l3_field)},'NA') AS l3_label, COALESCE(${sql(config.baseFormat.l4_field)},'NA') AS l4_label, COALESCE(${sql(config.baseFormat.l5_field)},'NA') AS l5_label, COALESCE(SUM(pj.lbs)/${(denominator.lbs)},0) AS lbs, COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSales", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS cogs, COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS othp, COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMargin", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSales", 0 AS "grossMarginPercent", COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSalesPerLb", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS "cogsPerLb", COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS "othpPerLb", COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMarginPerLb", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSalesPerLb"
...
const l0_getPercentSales = async (config, denominator, colName) => {
  ...
  try {
    ...
    const response = await sql
      `
      SELECT TRUE AS "percentFormat", ${colName} AS column, 'TOTAL' AS l1_label, COALESCE(SUM(pj.lbs)/${(denominator.lbs)},0) AS lbs, COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSales", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS cogs, COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS othp, COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMargin", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSales", 0 AS "grossMarginPercent", COALESCE(SUM(pj.sales)/${(denominator.sales)},0) AS "grossSalesPerLb", COALESCE(SUM(pj.cogs)/${(denominator.cogs)},0) AS "cogsPerLb", COALESCE(SUM(pj.othp)/${(denominator.othp)},0) AS "othpPerLb", COALESCE(SUM(pj.gross_margin)/${(denominator.gross_margin)},0) AS "grossMarginPerLb", COALESCE(SUM(pj.net_sales)/${(denominator.net_sales)},0) AS "netSalesPerLb"
