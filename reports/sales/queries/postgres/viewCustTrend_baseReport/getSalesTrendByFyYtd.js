...
const lvl_1_subtotal_getSalesByFyYtd = async (config, start, end, program, filters, level) => {
  try {
...
const lvl_0_total_getSalesByFyYtd = async (config, start, end, program, filters, level) => {
  try {
