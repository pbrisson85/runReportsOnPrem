...
const lvl_1_subtotal_getSo = async config => {
  try {
    console.log(`${config.user} - level 1: query postgres for FG Sales Orders (lvl_1_subtotal_getSo) ...`)
...
const lvl_1_subtotal_getSoTagged = async config => {
  try {
    console.log(`${config.user} - level 3: query postgres for FG Sales Orders (lvl_1_subtotal_getSoTagged) ...`)
...
const lvl_1_subtotal_getSoUntagged = async config => {
  try {
    console.log(`${config.user} - level 3: query postgres for FG Sales Orders (lvl_1_subtotal_getSoUntagged) ...`)
...
const lvl_2_subtotal_getSo = async config => {
  try {
    console.log(`${config.user} - level 2: query postgres for FG Sales Orders (lvl_2_subtotal_getSo) ...`)
...
const lvl_2_subtotal_getSoTagged = async config => {
  try {
    console.log(`${config.user} - level 3: query postgres for FG Sales Orders (lvl_2_subtotal_getSoTagged) ...`)
...
const lvl_2_subtotal_getSoUntagged = async config => {
  try {
    console.log(`${config.user} - level 3: query postgres for FG Sales Orders (lvl_2_subtotal_getSoUntagged) ...`)
...
const lvl_3_subtotal_getSo = async config => {
  try {
    console.log(`${config.user} - level 3: query postgres for FG Sales Orders (lvl_3_subtotal_getSo) ...`)
...
const lvl_3_subtotal_getSoTagged = async config => {
  try {
    console.log(`${config.user} - level 3: query postgres for FG Sales Orders (lvl_3_subtotal_getSoTagged) ...`)
...
const lvl_3_subtotal_getSoUntagged = async config => {
  try {
    console.log(`${config.user} - level 3: query postgres for FG Sales Orders (lvl_3_subtotal_getSoUntagged) ...`)
...
const lvl_4_subtotal_getSo = async config => {
  try {
    console.log(`${config.user} - level 4: query postgres for FG Sales Orders (lvl_4_subtotal_getSo) ...`)
...
const lvl_4_subtotal_getSoTagged = async config => {
  try {
    console.log(`${config.user} - level 4: query postgres for FG Sales Orders (lvl_4_subtotal_getSoTagged) ...`)
...
const lvl_4_subtotal_getSoUntagged = async config => {
  try {
    console.log(`${config.user} - level 4: query postgres for FG Sales Orders (lvl_4_subtotal_getSoUntagged) ...`)
...
const lvl_0_total_getSo = async config => {
  try {
    console.log(`${config.user} - level 0: query postgres for FG Sales Orders (lvl_0_total_getSo) ...`)
...
const lvl_0_total_getSoTagged = async config => {
  try {
    console.log(`${config.user} - level 0: query postgres for FG Sales Orders (lvl_0_total_getSoTagged) ...`)
...
const lvl_0_total_getSoUntagged = async config => {
  try {
    console.log(`${config.user} - level 0: query postgres for FG Sales Orders (lvl_0_total_getSoUntagged) ...`)
