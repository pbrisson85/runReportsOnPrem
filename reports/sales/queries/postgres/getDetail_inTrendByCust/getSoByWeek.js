...
const getSoByWk_detail = async (config, program, filters, weekSerial) => {
  try {
...
const getSoTagged_detail = async (config, program, filters, weekSerial) => {
  try {
    console.log(`level 3: query postgres for FG Sales Orders ...`)
...
const getSoByWkUntagged_detail = async (config, program, filters, weekSerial) => {
  try {
    console.log(`level 3: query postgres for FG Sales Orders ...`)
