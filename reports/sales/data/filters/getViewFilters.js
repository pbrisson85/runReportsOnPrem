  ...
  return [
    {
      ...
      cols: ['label', 'salesInvoice', 'salesOrder', 'invenFg', 'invenRm', 'purchaseOrder', 'salesKpi', 'invenKpi', 'salesProjection'], // list of colTypes that should be displayed in this view
    },
    {
      label: 'REVENUE $',
      dataName: 'revenue',
    ...
    },
    {
      ...
      dataName: 'cogs',
      additionalData: { decimals: 0 },
      cols: ['label', 'salesInvoice', 'salesOrder', 'invenFg', 'invenRm', 'purchaseOrder', 'salesKpi', 'invenKpi', 'salesProjection'],
    },
    {
      label: 'GROSS MARGIN',
