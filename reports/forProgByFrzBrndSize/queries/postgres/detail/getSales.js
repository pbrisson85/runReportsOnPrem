...
const lvl_2_subtotal_getSalesByWk_detail = async (program, filters, columnDataName, start, end) => {
  try {
    ...
    const response = await pgClient.query(
      ...
      WHERE sl.formatted_invoice_date >= $1 AND sl.formatted_invoice_date <= $2 AND ms.byproduct_type IS NULL AND ms.item_type = $3 AND ms.program = $4 AND ms.fg_fresh_frozen = $5 AND ms.brand = $6 AND sl.week_serial = $7`,
...
const lvl_2_subtotal_getSalesPeriodToDate_detail = async (start, end, program, filters) => {
  try {
    ...
    const response = await pgClient.query(
      ...
      WHERE sl.formatted_invoice_date >= $1 AND sl.formatted_invoice_date <= $2 AND ms.byproduct_type IS NULL AND ms.item_type = $3 AND ms.program = $4 AND ms.fg_fresh_frozen = $5 AND ms.brand = $6`,
...
const lvl_3_subtotal_getSalesByWk_detail = async (program, filters, columnDataName, start, end) => {
  try {
    ...
    const response = await pgClient.query(
      ...
      WHERE sl.formatted_invoice_date >= $1 AND sl.formatted_invoice_date <= $2 AND ms.byproduct_type IS NULL AND ms.item_type = $3 AND ms.program = $4 AND ms.fg_fresh_frozen = $5 AND ms.brand = $6 AND ms.size_name = $7 AND sl.week_serial = $8`,
...
const lvl_3_subtotal_getSalesPeriodToDate_detail = async (start, end, program, filters) => {
  try {
    ...
    const response = await pgClient.query(
      ...
      WHERE sl.formatted_invoice_date >= $1 AND sl.formatted_invoice_date <= $2 AND ms.byproduct_type IS NULL AND ms.item_type = $3 AND ms.program = $4 AND ms.fg_fresh_frozen = $5 AND ms.brand = $6 AND ms.size_name = $7`,
