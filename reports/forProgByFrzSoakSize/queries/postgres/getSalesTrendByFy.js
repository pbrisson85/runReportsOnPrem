...
const lvl_2_subtotal_getSalesByFy = async (start, end, program) => {
  try {
    ...
    const response = await pgClient.query(
      ...
      GROUP BY sales_line_items.fiscal_year, ms.fg_fresh_frozen, ms.fg_treatment 
...
const lvl_3_subtotal_getSalesByFy = async (start, end, program) => {
  try {
    ...
    const response = await pgClient.query(
      ...
      GROUP BY sales_line_items.fiscal_year, ms.fg_fresh_frozen, ms.fg_treatment, ms.size_name 
